  ...
  <div class="tou">
    ...
    <div class="user">
      ...
      <el-dialog center :title="name" :visible.sync="dialogVisible" width="30%">
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="(flag = true), mima()"
            >确 定</el-button
          >
        </span>
      </el-dialog>
      ...
      <el-dialog center :title="name" :visible.sync="dialogV" width="30%">
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="(flag = true), band()"
            >确 定</el-button
          >
        </span>
      </el-dialog>
      ...
      <el-dialog center :title="name" :visible.sync="youxiang" width="30%">
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="(flag = true), youband()"
            >确 定</el-button
          >
        </span>
      </el-dialog>
        ...
        <div class="zi">
          <div>
            <span
              ...
              >（<span style="color: #ffae00">未认证</span>
              <!-- , -->
              <!-- <span
    ...
    <div>
      ...
      <div class="font_sizi">
        ...
        <span class="font_sizi_our">
          您已绑定手机<span>{{ msg.telephone }}</span
