<template>
	<div class="tem-right" id="container">
      ...
      <div>
		...
		<div class="quans" v-show="flag1"></div>
        <div class="qq" v-show="flag2">
			<div class="zong02" >
                <div class="chongdianall">
                    <div class="top-close">
                        <img @click="close2" class="shangtu" src="../../assets/images/chacha.png" alt="" />
                    </div>
                    <div class="chongdianmiddlebox">
                        <div class="chongdianmiddle">
                            <div class="chongdianmiddle-left">
                                <div class="word">站点:</div>
                                <div class="word">枪口: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{index}}</div>
                            </div>
                            <div class="selecta">
                                <template>
                                <el-select @change="aa" v-model="value15" placeholder="请选择充电时间">
                                    <el-option
                    ...
                    <div class="chongdianbottom">
                        <div class="word">启动</div>
                    </div>
                </div>
			</div>
		</div>
			...
			<div class="zong" v-show="select == 1">
				...
				<div class="zong_right">
					<div class="but">
						...
						<el-button @click="restart" type="primary" style="background: #2971ff">重启设备</el-button>
					</div>
					<div>
						<div class="jw">
							经纬度（
				...
				<div class="chong_left test test-1">
					<div class="scrollbar">
						<el-scrollbar style="height: 100%">
							<div v-for="(item, id) in shebeiMsg.ports" @click="change(item.port, id, item.state, item)" :key="id" class="quan"
							 :class="{ back: selectss == item.id }">
								...
								<img class="immm" src="../../assets/images/smallIntng.png" alt="" />
							</div>
						</el-scrollbar>
					</div>
				</div>
					...
					<div class="cuowu2">
						...
						<div class="bu2">
							<div class="bu">
								...
								<span @click="chooseTime">启动充电</span>
							</div>
						</div>
					</div>
				</div>
	...
	export default {
		...
		methods: {
            bb(){
                ...
                this.$axios.get("/admin/api/chargers?taken=" + this.token)
                    then(res =>{
                        console.log(res)
                        if(res.status == 200){
			...
			start() {
				...
				this.$axios
                    ...
                    console.log(this.id)// this.id=76323
                    console.log(this.ports)//this.ports=1
...
<style scoped="scoped">
    ...
    .chongdianmiddle-left {
        width: 60%;
        display: flex;
        flex-direction: column;
        justify-content: start;
    }
    .chongdianmiddle-left>>>.word {
        font-size: 20px;
        height: 10%;
    }
    .chongdianbottom {
  ...
  border-radius: 50px;
    ...
    .selecta>>>.el-input__inner {
        border: 1px #7f8286 solid !important;
        height: 42px;
        width:270px
    }
