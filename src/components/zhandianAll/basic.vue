                  ...
                  <div>更换二维码</div>
					...
					<div>
						<div class="inp">
							<div>站点名称:</div>
							<div>
								<input type="text" v-model="input" placeholder="请输入内容" disabled="disabled" class="jibenInput banInput">
							</div>
						</div>
						<div class="inp">
							<div>类型:</div>
							<div>
								<input type="text" v-model="typeInput" placeholder="充电桩" disabled="disabled" class="jibenInput banInput">
							</div>
						</div>
						<div class="inp">
							<div>地址:</div>
							<div class="blueBorder">
								<input type="text" v-model="weiInput" placeholder=""  class="jibenInput">
							</div>
						</div>
						<!-- <div class="inp">
              <div>位置:</div>
