<template>
	<div class="oneCard-right">
		<div class="UserAssets-right-top">
			<div class="user-left">
				<span class="user-word">欠费记录</span>
			</div>
		...
		<div>
			<template>
				<el-table :data="cardList" stripe style="width: 100%">
					...
					<el-table-column prop="dealno" label="停车编号" show-overflow-tooltip="">
					</el-table-column>
					...
					<el-table-column prop="enter_time" label="驶入时间" width="180">
					</el-table-column>
					<el-table-column prop="leave_time" label="驶出时间" width="180">
					</el-table-column>
	...
	export default {
		...
		methods: {
			...
			getUserMes() {
				...
				//console.log(toKen)
				this.$axios.get("admin/api/pdrs/service/22/state/8/?token=" + toKen + "&page=" + this.pagenum + "&row=14")
					.then(res => {
