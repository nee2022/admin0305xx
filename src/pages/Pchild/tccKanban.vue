  ...
  <div class="road-right">
    ...
    <div class="wulianBot">
      <div class="wulianBotBox">
        ...
        <div class="roadBot">
          <div class="firstBox">
            <div class="firstBoxTop">停车场总量</div>
            <div class="firstBoxBot">
              {{ resourceAndRecord.station_type_2_count }}
            </div>
          </div>
          <div class="rightBox">
      ...
      <div class="wulianBotBox">
        ...
        <div class="ziyuanBox">
          <div class="boxBoxs">
            ...
            <div class="boxNum">
              {{ resourceAndRecord.payment_service_22_count }}
            </div>
          </div>
          <div class="boxBoxs">
            <div class="boxWord">停车费</div>
            <div class="boxNum1">
              {{ resourceAndRecord.payment_service_22_amount }}
            </div>
          </div>
          <div class="boxBoxs">
