<template>
	<div class="oneCard-right">
		<div class="UserAssets-right-top">
			<div class="user-left">
				<span class="user-word">充值记录</span>
			</div>
		...
		<div>
			<template>
				<el-table :data="menuList" stripe style="width: 100%">
					...
					<el-table-column prop="deal_no" label="订单号">
					</el-table-column>
				<!-- 	<el-table-column prop="state" label="状态">
					...
					<el-table-column prop="payee" label="支付用户">
					</el-table-column>
					<el-table-column prop="amount" label="订单金额">
					</el-table-column>
					<el-table-column prop="income" label="订单收入">
					</el-table-column>
					<el-table-column prop="pay" label="充值金额">
					</el-table-column>
	...
	export default {
		...
		methods: {
			...
			getUserMes() {
				...
				// console.log(toKen)
				this.$axios.get("admin/api/service/1/payments?token=" + toKen + "&page=" + this.pagenum +
					...
					.then(res => {
						...
						if (res.status == 200) {
							this.menuList = res.data.payments //用户列表数据
