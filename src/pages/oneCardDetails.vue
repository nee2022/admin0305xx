				...
				<el-menu default-active="2" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" background-color="#1e69fe"
				 text-color="#fff" active-text-color="white" unique-opened v-model="option">
					<el-menu-item index="1">
						<template slot="title">
							<router-link to="/oneCardjiben">
								<div class="menu-op">
									<div>
										<img src="../assets/images/user account.png">
									</div>
									<span class="menu-word-2">基本资料</span>
								</div>
							</router-link>
						</template>
					</el-menu-item>
					<el-menu-item index="2">
						<template slot="title">
							<router-link to="/oneCardUse">
								<div class="menu-op">
									<div>
										<img src="../assets/images/user account.png">
									</div>
									<span class="menu-word-2">使用记录</span>
								</div>
							</router-link>
						</template>
					</el-menu-item>
					<el-menu-item index="3">
						<template slot="title">
							<router-link to="/oneCardChongzhi">
								<div class="menu-op">
									<div>
										<img src="../assets/images/user account.png">
									</div>
...
<script>
	...
	export default {
		...
		created() {
			// console.log(this.menuList[1].list)
		},
		methods: {
