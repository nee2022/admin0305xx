			...
			<div class="userMes">
				...
				<div class="con-con1">
					<div class="con-con-box">
						<span>id:</span>
						<div><input type="text" disabled="disabled" class="jibenInput banInput"></div>
					</div>
					<div class="con-con-box">
						<span>可用状态:</span>
						<div>
							<el-switch  active-color="#1e69fe" inactive-color="#ccc">
							</el-switch>
						</div>
					</div>
					<div class="con-con-box">
						<span>积分:</span>
						<div>
							<input type="text" disabled="disabled" class="jibenInput banInput">
						</div>
					</div>
					<div class="con-con-box">
						<span>注册时间:</span>
	...
	export default {
		...
		methods: {
			...
			getUserMe() {
				...
				// console.log(toKen)
				this.$axios.get("admin/api/user/" + this.inputUserID + "/cards?token=" + toKen)
					.then(res => {
						// console.log(res.data)
						console.log(res)
						if (res.status == 200) {
							this.editForm=res.data.cards 	
						}
					})
			},
			// getEditForm(){
