<template>
	<div class="oneCard-right">
		<div class="UserAssets-right-top">
			<div class="user-left">
				<span class="user-word">停车记录</span>
			</div>
	...
	export default {
		...
		methods: {
			...
			getUserMes() {
				...
				// console.log("admin/api/pdrs?token=" + toKen + "&page=" + this.pagenum + "&row=14&service=22")
				this.$axios.get("admin/api/pdrs/service/21/?token=" + toKen + "&page=" + this.pagenum + "&row=14")
					.then(res => {
