<template>
  <div class="zyhSingleLineListMainPage AQIsensor">
    <header>
      <div class="infoArea">
            ...
            <div class="tableItem">
              ...
              <div class="meterInfo2">
                <ul>
                  ...
                  <li>
                    <div>
                      <img src="../../../../assets/images/tvoc.png" alt="" />
                    </div>
                    <div>
                      <span>TVOC</span>
                      <br />
...
<script>
import AQIsensor from "./AQIsensor.js";
