<template>
  <div class="zyhSingleLineListMainPage socket">
    <header>
      <div class="infoArea">
        <div class="pageName">插座</div>
        <div class="profile">
          <myhead></myhead>
        </div>
      </div>
      ...
      <template v-if="chart">
        <ul class="chartItems not-select">
          <li v-for="item in tableData" :key="item.id">
            <div class="tableItem1" v-if="item.styleId < 16">
              <div class="signBar">
            ...
            <div class="tableItem2" v-if="item.styleId === 16">
              <div class="signBar">
                <span class="circle"></span>
                <span>{{ item.id }}</span>
                <span>
            ...
            <div class="tableItem3" v-if="item.styleId === 17">
              <div class="signBar">
                <span class="circle"></span>
                <span>{{ item.id }}</span>
                <span>
