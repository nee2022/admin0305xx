    ...
    <section>
      <template>
        <el-table :data="tableData" stripe style="width: 100%">
          ...
          <el-table-column show-overflow-tooltip prop="id" label="最高电压">
            3.6240
          </el-table-column>
          <el-table-column show-overflow-tooltip prop="id" label="最低电压">
            3.6150
          </el-table-column>
          <el-table-column show-overflow-tooltip prop="id" label="最高温度">
            4
          </el-table-column>
          <el-table-column show-overflow-tooltip prop="id" label="最低温度">
            2
          </el-table-column>
