...
export default new Router({
  routes: [
    ...
    //设备监控
    {
      path: "/deviceManager",
      name: "deviceManager",
      component: () => import("../pages/SystemChild/deviceManager.vue")
    },
    //微服务监控
    {
      path: "/Microservice",
      name: "Microservice",
      component: () => import("../pages/SystemChild/Microservice.vue")
    },
    {
      path: "/chargeManager",
      name: "chargeManager",
      component: () => import("../pages/SystemChild/chargeManager.vue")
    },
    ...
    //促销优惠
    {
      ...
      children: [
        ...
        },
        {
          path: "/PtaocanTJ",
          name: "PtaocanTJ",
          component: () => import("../pages/PromotionalChild/PtaocanTJ.vue")
        },
        {
          path: "/PconponTJ",
          name: "PconponTJ",
          component: () => import("../pages/PromotionalChild/PconponTJ.vue")
        },
        {
          path: "/PchongzhiTJ",
          name: "PchongzhiTJ",
          component: () => import("../pages/PromotionalChild/PchongzhiTJ.vue")
        },
        {
          path: "/Pkanban",
          name: "Pkanban",
          component: () => import("../pages/PromotionalChild/Pkanban.vue")
        },
        {
          path: "/userTaocan",
          name: "userTaocan",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: "/tccBaobiao",
          name: "tccBaobiao",
          component: () => import("../pages/Pchild/tccBaobiao.vue")
        },
        {
          path: "/tccKanban",
          name: "tccKanban",
          component: () => import("../pages/Pchild/tccKanban.vue")
        },
        {
          path: "/Pbaoyue",
          name: "Pbaoyue",
    ...
    //道路停车
    {
      ...
      children: [
        ...
        },
        {
          path: "/roadMap",
          name: "roadMap",
          component: () => import("../pages/parksChild/roadMap.vue")
        },
        {
          path: "/jixiaobaobiao",
          name: "jixiaobaobiao",
          component: () => import("../pages/parksChild/jixiaobaobiao.vue")
        },
        {
          path: "/roadBaobiao",
          name: "roadBaobiao",
          component: () => import("../pages/parksChild/roadBaobiao.vue")
        },
        {
          path: "/dici",
          name: "dici",
          component: () => import("../pages/parksChild/dici.vue")
        },
        {
          path: "/roadKanban",
          name: "roadKanban",
          component: () => import("../pages/parksChild/roadKanban.vue")
        },
        {
          path: "/view",
          name: "view",
    ...
    //用户资产
    {
      ...
      children: [
        ...
        },
        {
          path: "/userkanban",
          name: "userkanban",
          component: () => import("../pages/UserAssetsChild/userkanban.vue")
        },
        {
          path: "/UserStatistics",
          name: "UserStatistics",
          component: () => import("../pages/UserAssetsChild/UserStatistics.vue")
        },
        {
          path: "/conponTJ",
          name: "conponTJ",
          component: () => import("../pages/UserAssetsChild/conponTJ.vue")
        },
        {
          path: "/tancanTJ",
          name: "tancanTJ",
          component: () => import("../pages/UserAssetsChild/tancanTJ.vue")
        },
        {
          path: "/yikatongTJ",
          name: "yikatongTJ",
          component: () => import("../pages/UserAssetsChild/yikatongTJ.vue")
        },
        {
          path: "/coupon",
          name: "coupon",
    ...
    //电单车充电
    {
      ...
      children: [
        ...
        },
        {
          path: "/motoBaobiao",
          name: "motoBaobiao",
          component: () => import("../components/motorcycles/motoBaobiao.vue")
        },
        {
          path: "/motoOperators",
          name: "motoOperators",
          component: () => import("../components/motorcycles/motoOperators.vue")
        },
        {
        ...
        },
        {
          path: "/motoKanban",
          name: "motoKanban",
          component: () => import("../components/motorcycles/motoKanban.vue")
        },
        {
          path: "/equipment",
          component: equipment
    ...
    //电单车充电大数据
    {
      path: "/motoBigData",
      name: "motoBigData",
      component: () => import("../components/motorcycles/motoBigData.vue")
    },
    //汽车充电
    {
      ...
      children: [
        ...
        },
        {
          path: "/allmoto",
          name: "allmoto",
          component: () => import("../components/car/allmoto.vue")
        },
        {
          path: "/realTime",
          component: realTime
        ...
        },
        {
          path: "/carBaobiao",
          name: "carBaobiao",
          component: () => import("../components/car/carBaobiao.vue")
        },
        {
          path: "/caryunying",
          name: "caryunying",
          component: () => import("../components/car/caryunying.vue")
        },
        {
          path: "/carshanghu",
          name: "carshanghu",
          component: () => import("../components/car/carshanghu.vue")
        },
        {
          path: "/carKanban",
          name: "carKanban",
          component: () => import("../components/car/carKanban.vue")
        },
        {
          path: "/cartaocan",
          component: cartaocan
    ...
    //物联设备
    {
      ...
      children: [
        ...
        },
        {
          path: "/wulianKanban",
          name: "wulianKanban",
          component: () => import("../components/wulian/wulianKanban.vue")
        },
        {
          path: "/unbound",
          component: unbound
    ...
    //电单车充电
    {
      ...
      children: [
        {
          path: "/basicmotoStation",
          component: basicmotoStation
        },
        {
          path: "/chargingRecordmotoStation",
          component: chargingRecordmotoStation
        },
        {
